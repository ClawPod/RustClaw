...
const SNAPSHOT_HEADER: &str = "# 🧠 RustClaw Memory Snapshot\n\n\
    > Auto-generated by RustClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 RustClaw Memory Snapshot
...
I am RustClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 RustClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
